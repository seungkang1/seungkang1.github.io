...
public class Driver {
   ...
   public static void initializeMonkeyList() {
    ...
    public static void reserveAnimal(Scanner scanner) {
        ...
        if (animalType.equalsIgnoreCase("dog")) {
            for (Dog dog : dogList) {
                if (dog.getTrainingStatus().equalsIgnoreCase("in service")
                        && dog.getInServiceLocation().equalsIgnoreCase(inServiceCountry) && !dog.getReserved()) {
            ...
            for (Monkey monkey : monkeyList) {
                if (monkey.getTrainingStatus().equalsIgnoreCase("in service")
                        && monkey.getInServiceLocation().equalsIgnoreCase(inServiceCountry) && !monkey.getReserved()) {
        ...
        System.out.println("No available animals of that type and location.");
    }
